...
import io.github.thebutterbrotman.just_enough_hammers.common.item.util.AreaToolUtil;
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(new LiteralText(
                MessageFormat.format(
                        new TranslatableText("tooltip.just_enough_hammers.hammer_1").getString(),
                        new TranslatableText("tooltip.just_enough_hammers.stability." + stabilityKey).getString())).formatted(formatting));

        tooltip.add(new LiteralText(""));
        tooltip.add(new TranslatableText("tooltip.just_enough_hammers.hammer_2").formatted(Formatting.AQUA));
        tooltip.add(new TranslatableText("tooltip.just_enough_hammers.hammer_3").formatted(Formatting.AQUA));
    }
